...
export const BASE_NAME = <h1 className="text-5xl font-extrabold flex-col px-2 flex md:flex-row font-serif uppercase text-white">
  S<span className="text-red-600">t</span>even <span className="text-red-700"> twelwe</span>
</h1>
